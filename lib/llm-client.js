...
import * as anthropicCompat from "./providers/anthropic_compat.js";
...
const BUILTIN = [
  ...
  { id: "hunyuan", label: "腾讯混元", module: openaiCompat, defaultBaseUrl: "https://hunyuan.tencentcloudapi.com" },
  { id: "xinghuo", label: "讯飞星火", module: openaiCompat, defaultBaseUrl: "https://spark-api-open.xf-yun.com/v1" },
  { id: "ernie", label: "文心一言", module: openaiCompat, defaultBaseUrl: "https://aip.baidubce.com/rpc/2.0/ai_custom/v1/wenxinworkshop" },
  { id: "stepfun", label: "阶跃星辰", module: openaiCompat, defaultBaseUrl: "https://api.stepfun.com/v1" },
  { id: "lingyi", label: "零一万物", module: openaiCompat, defaultBaseUrl: "https://api.lingyiwanwu.com/v1" },
  { id: "doubao", label: "豆包 (火山引擎)", module: openaiCompat, defaultBaseUrl: "https://ark.cn-beijing.volces.com/api/v3" },
  { id: "internlm", label: "书生浦语", module: openaiCompat, defaultBaseUrl: "https://internlm-chat.intern-ai.org.cn/api/v1" },
  { id: "minimax", label: "MiniMax", module: openaiCompat, defaultBaseUrl: "https://api.minimax.chat/v1" },
  
  // 中国主流大模型厂商 - Anthropic 兼容
  { id: "anthropic-compat", label: "自定义 (Anthropic 兼容)", module: anthropicCompat, defaultBaseUrl: "" },
