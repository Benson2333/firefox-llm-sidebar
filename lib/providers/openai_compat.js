...
export function create(cfg) {
  ...
  function inferModelMeta(id) {
    ...
    const isVision = /vision|gpt-4o|gpt-4\.1|gpt-5|claude-(3|4|opus|sonnet|haiku)|gemini|qwen.*-vl|glm-4v|qvq|doubao.*vision|step-1v|yi-vision|internvl|llava|minicpm-v|llama-3\.2-vision|llama4|molmo|paligemma|llama-3\.2-11b|llama-3\.2-90b/.test(lower);
